...
import 'package:wheater_app/presentation/providers/weather_notifier.dart';
import 'package:wheater_app/presentation/providers/weather_state.dart';
import 'package:wheater_app/presentation/widgets/search_bar_widget.dart';
...
class HomeScreen extends ConsumerWidget {
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          ...
          if (weatherState is WeatherLoaded) {
            await ref
                .read(weatherNotifierProvider.notifier)
                .fetchWeatherForCity(weatherState.weather.cityName);
  ...
  Widget _buildDefaultCitiesList(
    ...
    List<String> citiesToShow = List.from(AppConstants.defaultCities);
    ...
    if (savedSearchesAsyncValue is SavedSearchesLoaded) {
      final recentCityNames =
          savedSearchesAsyncValue.searches
              ...
              .toSet();
      citiesToShow.removeWhere(
        (city) => recentCityNames.contains(city.toLowerCase()),
      );
    }
  ...
  Widget _buildCityListItem(
    ...
    return ListTile(
      ...
      onTap: () {
        ...
        ref
            .read(weatherNotifierProvider.notifier)
            .fetchWeatherForCity(weather.cityName);
